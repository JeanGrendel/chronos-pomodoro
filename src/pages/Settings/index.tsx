...
export function Settings() {
  ...
  function handleSaveSettings(e: React.SubmitEvent<HTMLFormElement>) {
    ...
    if (workTime < 1 || workTime > 99) {
      formErrors.push('Digite valores entre 1 e 99 para ao Foco.')
    }

     if (shortBreakTime < 1 || shortBreakTime > 30) {
      formErrors.push('Digite valores entre 1 e 30 para ao Descanso Curto.')
    }

    if (shortBreakTime < 1 || shortBreakTime > 60) {
      formErrors.push('Digite valores entre 1 e 60 para ao Descanso Longo.')
    }
